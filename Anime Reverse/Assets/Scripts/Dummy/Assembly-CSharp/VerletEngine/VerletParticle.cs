...
namespace VerletEngine
{
	public class VerletParticle
	{
		...
		public void UpdateVerlet(Vector3 objectMove, Vector3 acceleration, float timeStep, float lastTimestep = -1f, float dbTimeStep = -1f)
		{
			...
			if (m_ParentIndex >= 0)
			{
				v19.x = this.m_Position.x;
				v19.y = this.m_Position.y;
				z = this.m_Position.z;
				v21 = this.m_PrevPosition.z;
				v22.x = this.m_PrevPosition.x;
				v22.y = this.m_PrevPosition.y;
				v60.z = z;
				v61.x = v22.x;
				v61.y = v22.y;
				v61.z = v21;
				...
				v61.x = v28.x;
				v61.y = v28.y;
				v29.x = this.m_Position.x;
				v29.y = this.m_Position.y;
				v61.z = v27.x;
				...
				v60.z = v27.x;
				v30 = v60 + v61;
				this.m_Position.x = v30.x;
				this.m_Position.y = v30.y;
				v31 = v30.z;
				this.m_Position.z = v31;
				this.m_PrevPosition = v30;
				if (lastTimestep <= 0f)
				{
					v48.x = this.m_Position.x;
					v48.y = this.m_Position.y;
					v49 = v31;
					v50 = this.m_Damping;
					v61.x = v25.x;
					v61.y = v25.y;
					v61.z = v26;
					v51 = v61 * (1f - v50);
					v61.x = acceleration.x;
					v61.y = acceleration.y;
					v52.x = v51.x;
					v52.y = v51.y;
					v53 = v51.z;
				...
				else
				{
					...
					v36.x = v34.x;
					v36.y = v34.y;
					v37.x = this.m_Position.x;
					v37.y = this.m_Position.y;
			...
			else
			{
				...
				this.m_PrevPosition.y = this.m_Position.y;
				this.m_PrevPosition.z = v12;
				v13 = boneTransform.position;
				v14.x = this.m_posOffset.x;
				v14.y = this.m_posOffset.y;
			...
			this.m_Position.x = v18.x;
			this.m_Position.y = v18.y;
